...
<div id="middle" style="position:relative; width:100%; padding:50px 0px; background:#FFF;">
            ...
            <?php
              ...
              if($list){
		    	...
		    	echo "<a href='exebition_edit.php?artistid=".@$artistId."''><input type='submit' class='submit' name='Add' value='Add Entry' /></a>
                ...
                echo "<table cellpadding='0' cellspacing='0' border='0' class='listingTable' width='100%'>
                    ...
                    while($row=fetchArray($result)){
                        ...
                        echo '<tr>';
                            ...
                            echo"<td>".sanitizeInput(@$exebition_type)."</td>";
                        echo"<td>";
                        echo"<form action='exebition_edit.php' method='post'>
                                <input type='hidden' name='id' value='".$id."'/>
                                <inpit type='hidden' name='artistid' value ='".$artistId."'/>
