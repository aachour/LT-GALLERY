        ...
        <?php
            if(@$save){
                ...
                if(@$error==''){
                    ...
                    if(!isEmpty($entryId)){
                        ...
                        `exebitions_id`='".sanitizeInput($exebitions_id,"HTML")."',
                        ...
                        $query="INSERT INTO `".$table."`(`artists_id` , `exebitions_id` , `exebition_type`, `years` , `text` , `link` , `datesubmit` , `status`)
                         VALUE(
                    ...
                    if(runQuery($query)){
                        ...
                        $prompt=0;
                        echo"<meta http-equiv='refresh' content='2;url=exebtion_index.php'>";
                    }else{
            ...
            if($prompt==1){
                if(isset($entryId) && $entryId != ''){
                    ...
                    $exebitions_id=json_decode($exebitions_id);
            ...
            <tr height="20px"></tr>
                          ...
                          $result2=runQuery($query2);
                            if(numRows($result2)>0){
                                while($row2=fetchArray($result2)){
                                    ...
                                    $selected="";
                                    if(in_array($artistId,@$artists_id)){
                                        $selected="selected";
                                    }
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <input onclick="window.location='exebtion_index.php'" class='submit' value='Cancel' type='Button' />
                    </td>
                </tr>              
