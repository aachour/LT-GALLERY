			...
			<div class="content">
				...
				<div class="col2">
					<div class="nav textRight">
						...
						<a class="small proximaMd <?php if(@$CURRENT_SECTION=="PODCASTS"){echo "red";}else{echo "blackRed";}?>" href="pages/podcasts.php">Podcasts</a>
						<a class="small proximaMd <?php if(@$CURRENT_SECTION=="NEWS"){echo "red";}else{echo "blackRed";}?>" href="pages/news.php/">News</a>
